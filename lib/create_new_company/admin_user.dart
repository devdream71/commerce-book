...
class AdminUser extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        padding: const EdgeInsets.only(left : 90.0, right: 90.0, top: 90, bottom: 90  ),
        child: Container(
          ...
          child: Row(children: [
            ...
            const Expanded(
              child: Padding(
                padding: EdgeInsets.only(left: 80.0, top: 80),
                child: Column(
          ...
          child: isHeader
              ...
              : Center(
                  child: cell == 'Open'
                      ...
                      }, child: const Text("Open", style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold),))
